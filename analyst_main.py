...
import time
from rating_scraper import scrap_analyst_function
...
if __name__ == "__main__":
  ...
  p1 = Process(target=scrap_analyst_function, args=(symbol_list[:i1], 1))
  p2 = Process(target=scrap_analyst_function, args=(symbol_list[i1:i2], 2))
  p3 = Process(target=scrap_analyst_function, args=(symbol_list[i2:i3], 3))
  p4 = Process(target=scrap_analyst_function, args=(symbol_list[i3:], 4))
